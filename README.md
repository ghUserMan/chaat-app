...
### 17.23 Automatic Scrolling
Прокручивать чат до расположения последнего сообщения
Причём когда чулвоек скролит руками это не должно работать, а когда возвращается на дно - опять работать
долго считаем требуемую высоту и всё за зря, не всегад срабатывает
